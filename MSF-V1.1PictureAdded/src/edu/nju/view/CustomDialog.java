...
public class CustomDialog {
	 ...
	 *  
	 */
	public CustomDialog(JFrame ui){
		super();
		ok = false;
		
		panel = new JPanel();
		dialog = new JDialog(ui, "custom", true);
		...
		okBtn.setBounds(120, 30, 75, 25);
		cancelBtn.setBounds(120, 85, 75, 25);
		...
		okBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("minNum: "+mineNumber);
				dialog.setVisible(false);
				SController.setCustomizedGameLevel(height, width, mineNumber);
			}
	...
	private SettingControllerImpl SController = new SettingControllerImpl();
